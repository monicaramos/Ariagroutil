...
Begin VB.Form frmInfAvnics 
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1560
         MouseIcon       =   "frmInfAvnics.frx":0122
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1545
         MouseIcon       =   "frmInfAvnics.frx":0274
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   1215
         Width           =   240
   ...
   End
End
Attribute VB_Name = "frmInfAvnics"
...
InicializarVbles
    ...
    'D/H Fecha vencimiento
    cDesde = Trim(txtCodigo(2).Text)
    cHasta = Trim(txtCodigo(3).Text)
    If Not (cDesde = "" And cHasta = "") Then
        'Cadena para seleccion Desde y Hasta
        Codigo = "{" & Tabla & ".fechavto}"
        TipCod = "F"
        If Not PonerDesdeHasta(cDesde, cHasta, "", "", "pDHfechaVto= """) Then Exit Sub
    End If
    
    'D/H Ejercicio
    cDesde = Trim(txtCodigo(4).Text)
    cHasta = Trim(txtCodigo(4).Text)
    If Not (cDesde = "" And cHasta = "") Then
        'Cadena para seleccion Desde y Hasta
        Codigo = "{" & Tabla & ".anoejerc}"
        TipCod = "N"
        If Not PonerDesdeHasta(cDesde, cHasta, "", "", "pDHejercici= """) Then Exit Sub
