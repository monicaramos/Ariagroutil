...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    If Not Facturas Then
        Select Case Conexion
            ...
            Case cContaGas
                adodc1.ConnectionString = ConnContaGas 'BD de la Contabilidad de gasolinera
            Case cContaFacSoc
                adodc1.ConnectionString = ConnContaFacSoc 'BD de la Contabilidad de Facturas Socios
            Case cContaCV
                adodc1.ConnectionString = ConnContaCV 'BD de la Contabilidad facturas coarval
            Case cContaCVV
                adodc1.ConnectionString = ConnContaCVV 'BD de la Contabilidad facturas coarval varias
        End Select
    Else
