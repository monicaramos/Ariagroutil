...
'    txtAux2(2).Text = DataGrid1.Columns(20).Text
    txtAux(6).Text = DataGrid1.Columns(20).Text
...
'    CadenaConsulta = CadenaConsulta & "cvfacturas.intconta, cvfacturas.codmactasoc, conta" & vParamAplic.NumeroContaCV & ".cuentas.nommacta, cvfacturas.totalfac, "
...
'    adodc1.ConnectionString = Conn
    ...
    tots = tots & "S|txtAux(0)|T|Ser.|500|;S|txtAux(1)|T|Factura|1150|;"
    ...
    tots = tots & "S|btnBuscar(0)|B|||;" '"N|txtAux2(2)|T|Nombre|2600|;"
    tots = tots & "S|txtAux(6)|T|Total Factura|1550|;"
...
Dim i As Integer
    ...
    txtAux(19).Text = DataGrid1.Columns(22).Text ' forma de pago
    
    txtAux(7).Text = DataGrid1.Columns(21).Text ' cuenta contable ventas
