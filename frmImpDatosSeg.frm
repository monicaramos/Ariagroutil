...
Begin VB.Form frmImpDatosSeg 
   ...
   End
End
Attribute VB_Name = "frmImpDatosSeg"
...
Dim CtaContable As String
    ...
    While Not EOF(nf)
        ...
        lblProgres(1).Caption = "Linea " & i
        Me.Refresh
        CtaContable = RecuperaValor(cad, 3, ";")
        
        'MIRAMOS SI EXISTE EL NIF
        NifSocio = ""
        NifSocio = DevuelveDesdeBDNew(cContaSeg, "cuentas", "nifdatos", "codmacta", Nif, "T")
