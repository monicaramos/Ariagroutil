...
'    conn.Execute SQL
    ...
    If numfactu > 0 Then
        ...
        If Not cContaFra.EstablecerValoresInciales(ConnContaFacSoc) Then
        ...
        While Not Rs.EOF
            ...
            If PasarFacturaSoc(Sql, txtCodigo(1).Text, txtCodigo(4).Text, txtCodigo(3).Text, cContaFra) = False And b Then b = False
