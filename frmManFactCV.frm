...
Dim b As Boolean
    ...
    If adodc1.Recordset.RecordCount > 0 Then b = b And (chkAbonos(0).Value = 0)
...
'
    ...
    CadB = "cvfacturas.numfactu is null"
    CargaGrid CadB
...
'    adodc1.ConnectionString = Conn
    ...
    tots = tots & "S|txtAux(0)|T|Ser.|400|;S|txtAux(1)|T|Factura|1050|;"
