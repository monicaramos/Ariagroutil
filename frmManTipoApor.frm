...
Begin VB.Form frmManTipoApor 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Tipos de Aportaciones"
   ClientHeight    =   5955
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7650
   Icon            =   "frmManTipoApor.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5955
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   0
      Tag             =   "Codigo Aportación|N|N|1|99|tipoapor|codaport|00|S|"
      Text            =   "Cod"
      Top             =   4515
      Width           =   555
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Nombre|T|N|||tipoapor|nomaport|||"
      Text            =   "Nombre"
      Top             =   4515
      Width           =   2295
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   2
      Tag             =   "Contador|N|N|0|9999999|tipoapor|contador|0000000||"
      Text            =   "Contado"
      Top             =   4515
      Width           =   1545
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   1
      TabIndex        =   3
      Tag             =   "Nº Serie|T|N|||tipoapor|codserie|||"
      Text            =   "L"
      Top             =   4500
      Width           =   555
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManTipoApor.frx":000C
      Height          =   4095
      Left            =   120
      TabIndex        =   8
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmManTipoApor"
...
' +-+- Menú: Tipos de Aportación (con un par)               +-+-
' +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-
...
'    PonerIndicador lblIndicador, Modo
    ...
    BloquearTxt txtAux(0), (Modo = 4) 'codaport
...
Dim i As Integer
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("tipoapor", "codaport")
    End If
    '***************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from tipoapor where codaport = " & adodc1.Recordset!codaport
                ...
                If InsertarDesdeForm2(Me, 0) Then
                    ...
                    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
                        ...
                        If Not adodc1.Recordset.EOF Then
                            ...
                            adodc1.Recordset.Filter = "codaport = " & txtAux(0).Text
                            ' ****************************************************
                        End If
                        cmdRegresar_Click
                    Else
...
Dim i As Integer
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT codaport, nomaport, contador, codserie"
    CadenaConsulta = CadenaConsulta & " FROM tipoapor "
    '************************************************************************
...
'    adodc1.ConnectionString = Conn
    ...
    Sql = Sql & " ORDER BY codaport"
    '**************************************************************++
       
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, False
       
    ' *** posar només els controls del grid ***
    tots = "S|txtAux(0)|T|Cód.|450|;S|txtAux(1)|T|Denominación|2900|;S|txtAux(2)|T|Contador|900|;"
    tots = tots & "S|txtAux(3)|T|Serie|600|;"
...
' *************************************
    ...
    If b And (Modo = 3) Then
        ...
        Datos = DevuelveDesdeBD("codaport", "tipoapor", "codaport", txtAux(0).Text, "N")
         
        If Datos <> "" Then
            MsgBox "Ya existe el Tipo de Aportación: " & txtAux(0).Text, vbExclamation
            b = False
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomEmpre & "'|pOrden={tipoapor.codaport}|"
