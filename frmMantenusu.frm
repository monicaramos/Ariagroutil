...
Private Sub cmdUsu_Click(Index As Integer)
    ...
    Case 2, 3
        ...
        If Index = 2 Then
            ...
            sql = "El usuario " & ListView1.SelectedItem.SubItems(1) & " será eliminado y no tendra acceso a los programas de Ariadna (AriConta, Avnics ....) ." & vbCrLf
            sql = sql & vbCrLf & "                              ¿Desea continuar?"
            If MsgBox(sql, vbQuestion + vbYesNo) = vbNo Then Exit Sub
            sql = "DELETE from usuarios where codusu = " & ListView1.SelectedItem.Text
            
        Else
            sql = "Al usuario " & ListView1.SelectedItem.SubItems(1) & " no le estará permitido el acceso al programa Avnics." & vbCrLf
            sql = sql & vbCrLf & "                              ¿Desea continuar?"
            If MsgBox(sql, vbQuestion + vbYesNo) = vbNo Then Exit Sub
            ...
            If Not miRsAux.EOF Then
                ...
                Else
                    ...
                    Else
                        ...
                        sql = sql & "¿Desea agregarlo como usuario a Avnics?"
...
Dim J As Integer
    ...
    sql = "Select * from appmenus where aplicacion='Avnics'"
    ...
    sql = "Select * from appmenususuario where aplicacion='Avnics' AND codusu =" & ListView1.SelectedItem.Text
    miRsAux.Open sql, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    While Not miRsAux.EOF
...
Private Sub GuardarMenuUsuario()
    sql = "DELETE from appmenususuario where aplicacion='Avnics' AND codusu =" & ListView1.SelectedItem.Text
    conn.Execute sql
    
    i = 0
    sql = "INSERT INTO appmenususuario (aplicacion, codusu, codigo, tag) VALUES ('Avnics'," & ListView1.SelectedItem.Text & ","
