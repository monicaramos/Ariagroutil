...
Begin VB.Form frmDatos2 
   ...
   Begin VB.CommandButton Command1 
      Height          =   375
      Left            =   3360
      Picture         =   "frmDatos2.frx":6852
      Style           =   1  'Graphical
      TabIndex        =   3
      ToolTipText     =   "Comprobar NIF socio"
      Top             =   6480
      Width           =   375
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatos2.frx":6954
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatos2.frx":C576
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatos2.frx":CB10
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatos2.frx":D0AA
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDatos2.frx":E83C
            Key             =   ""
         EndProperty
      EndProperty
   End
    ...
    For i = N To 1 Step -1
        If ListView1.ListItems(i).Checked Then
            If ListView1.ListItems(i).SmallIcon = 1 Or ListView1.ListItems(i).SmallIcon = 4 Then
                ...
                C = C & "baseimpo,cuotaiva,totalfac,intconta) VALUES (" & DBSet(vParamAplic.NumSerieTel, "T") & ","
...
Dim Desplaza As Integer
    ...
    Me.Label1.Caption = "Comprobar NIF socio"
    Label1.Refresh
    C = ""
    J = 0
    Inicio = 1
...
Dim S As String
    ...
    If Campos > 0 And Campos < 13 Then
        ...
        Else
            ...
            C = QuitaPrimeraUltimaComilla(CStr(Vector(3)))
            ...
            For i = 4 To 6
                ...
                C = PonerImporte(QuitaPrimeraUltimaComilla(CStr(Vector(i + 6))))
                IT.SubItems(i) = C
            Next
...
Private Function ComprobarLinea() As Boolean
 ...
 Dim C As String
    ...
    If Not ComprobarNIFConta(C) Then TienErr = TienErr & " NIF Socio no existe en contabilidad."
...
Private Function ComprobarNIFConta(C As String) As Boolean
    If vParamAplic.NumDiarioTel <> 0 Then
        ComprobarNIFConta = (DevuelveDesdeBDNew(cContaTel, "cuentas", "nifdatos", "nifdatos", C, "T") <> "")
    End If
End Function
