...
Begin VB.Form frmContConta 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Contadores Contabilidad"
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5355
   Icon            =   "frmContConta.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   4
      Tag             =   "Código|T|N|||contadores|tiporegi||S|"
      Text            =   "Dat"
      Top             =   4680
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   5
      Tag             =   "Descripción|T|N|||contadores|nomregis|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmContConta.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   3
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmContConta"
...
Private Sub BotonVerTodos()
    CadB = "tiporegi >= 'A' and tiporegi < 'Z'"
    CargaGrid CadB
    PonerModo 2
End Sub
...
Dim Sql As String
    Select Case Modo
        Case 1  'BUSQUEDA
            ...
            If CadB <> "" Then
                PonerModo 2
'[Monica] 09/09/2009 : sustituido el cadbusqueda de abajo por sql
                If CadBusqueda <> "" Then Sql = " and tiporegi like '%" & CadBusqueda & "%'"
                CargaGrid CadB & Sql  'CadBusqueda
...
'On Error Resume Next
    ...
    Select Case Modo
        Case 1 'BUSQUEDA
            If CadB <> "" Then
                CargaGrid CadB & CadBusqueda
            Else
                CargaGrid CadBusqueda
...
'        Else
            ...
            If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "tiporegi like " & DBSet(CodigoActual, "T"), "", True
            End If
'        End If
    End If
End Sub
...
'    PonerOpcionesMenu  'En funcion del usuario
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select tiporegi, nomregis from contadores "
    '************************************************************************
    If CadBusqueda = "" Then
        CadB = " tiporegi >= 'A' and tiporegi < 'Z' "
    Else
        CadB = " tiporegi >= 'A' and tiporegi < 'Z' and tiporegi like '%" & CadBusqueda & "%'"
    End If
    CargaGrid CadB
'    lblIndicador.Caption = ""
'    PonerModo 2
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    If Not Facturas Then
        Select Case Conexion
            ...
            Case cContaFacSoc
                adodc1.ConnectionString = ConnContaFacSoc 'BD de la Contabilidad facturas socios
            Case cContaCV
                adodc1.ConnectionString = ConnContaCV 'BD de la Contabilidad coarval
            Case cContaCVV
                adodc1.ConnectionString = ConnContaCVV 'BD de la Contabilidad coarval varias
        End Select
    Else
