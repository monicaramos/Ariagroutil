...
Begin VB.Form frmSecciones 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   0
      Tag             =   "Sección|N|N|1|99|seccion|codsecci|00|S|"
      Text            =   "Cod"
      Top             =   2760
      Width           =   555
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmSecciones.frx":000C
      Height          =   6825
      Left            =   120
      TabIndex        =   12
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmSecciones"
...
Private Sub btnBuscar_Click(Index As Integer)
    TerminaBloquear
    Select Case Index
        Case 0 'Raiz de Cta Contable
            indice = Index + 2
            Set frmCtas = New frmCtasConta
            numNivel = DevuelveDesdeBDNew(cContaSeg, "empresa", "numnivel", "", "", "")
            frmCtas.NumDigit = DevuelveDesdeBDNew(cContaSeg, "empresa", "numdigi" & numNivel - 1, "", "", "")
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(0)|T|Avnic|800|;S|txtAux(1)|T|Ejerc.|650|;S|btnBuscar(0)|B||195|;S|txtAux2(1)|T|Nombre|3200|;S|txtAux(2)|T|Fecha|1000|;S|btnBuscar(1)|B||195|;"
