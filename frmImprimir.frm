...
Public outCodigoCliProv As String
...
Public Facturas As Boolean ' si true venimos de facturas varias
Public Contabilidad As Byte ' numero de contabilidad
                            ' cconta  = avnics
                            ' ccontaseg = seguros
                            ' ccontatel = telefonia
                            ' ccontafacsoc = facturas socios
...
Dim otromail As String
    ...
    If outTipoDocumento < 50 Then
        ...
        campoemail = ""
        If AbrirConexionContaFac(vParamAplic.UsuarioContaFac, vParamAplic.PasswordContaFac, CByte(Contabilidad)) Then
            campoemail = "maidatos"
            campoemail = DevuelveDesdeBDNewFac("cuentas", campoemail, "codmacta", Me.outCodigoCliProv, "T")
