...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT codigiva,nombriva,porceiva,porcerec,CASE tipodiva WHEN 0 THEN ""IVA"" WHEN 1 THEN ""IGIC"" WHEN 2 THEN ""BIEN DE INVERSIÓN"" WHEN 3 THEN ""R.E.A."" END,cuentare,cuentarr,cuentaso,cuentasr,cuentasn FROM tiposiva "
    '************************************************************************
    CadB = ""
    CargaGrid
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Cod.|600|;S|txtAux(1)|T|Descripción|1800|;" 'codigiva, nombriva
