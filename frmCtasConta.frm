...
'[Monica] 09/09/2009 : sustituido el cadbusqueda de abajo por sql
                If CadBusqueda <> "" Then Sql = " and codmacta like '" & CadBusqueda & "%'"
                If NumDigit = 0 Then
                    CargaGrid CadB & " AND apudirec='S'" & Sql 'CadBusqueda
                Else
                    CargaGrid CadB & " AND length(codmacta) = " & NumDigit & Sql 'CadBusqueda
                End If
...
'On Error Resume Next
    ...
    Select Case Modo
        Case 1 'BUSQUEDA
            If CadB <> "" Then
                If NumDigit = 0 Then
                    CargaGrid CadB & " AND apudirec='S'" & CadBusqueda
                Else
                    CargaGrid CadB & " AND length(codmacta) = " & NumDigit & CadBusqueda
                End If
'                lblIndicador.Caption = "RESULTADO BUSQUEDA"
            Else
                If NumDigit = 0 Then
                    CargaGrid "apudirec= 'S'" & CadBusqueda
                Else
                    CargaGrid "length(codmacta) = " & NumDigit & CadBusqueda
                End If
...
'    PonerOpcionesMenu  'En funcion del usuario
    ...
    If CadBusqueda = "" Then
        CadB = ""
    Else
        CadB = " and codmacta like '" & CadBusqueda & "%'"
    End If
    If NumDigit = 0 Then
        CargaGrid "apudirec='S'" & CadB
    Else
        CargaGrid "length(codmacta) = " & NumDigit & CadB
    End If
'    lblIndicador.Caption = ""
'    PonerModo 2
End Sub
